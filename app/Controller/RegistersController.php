...
class RegistersController extends AppController {
    ...
    public function regist()
    {
        ...
        $res = $this->DBCenter->getUserID(80);
        ...
        { 
            ...
            catch (FacebookApiException $e)
            {
                ...
                $temp = array();
                $temp["id"] = $res[$i]["id"];
                $temp["fb_id"] = $res[$i]["user_id"];
                $temp["email"] = $temp["hometown"] = $temp["birthday"] = "notexist";
                $temp["hobby"] = $temp["gender"] = $temp["age"] = $temp["height"] = $temp["bodytype"] = $temp["sports"] = $temp["marriage_history"] = 0;
                $temp["race"] = $temp["education"] = $temp["language"] = $temp["smoke"] = $temp["drinking"] = $temp["driving"] = $temp["exercise"] = 0;
                $temp["children_num"] = $temp["want_children"] = $temp["job"] = $temp["salary"] = $temp["pet"] = $temp["constellation"] = 0;
